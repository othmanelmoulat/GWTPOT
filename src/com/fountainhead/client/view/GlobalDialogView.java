...
import com.fountainhead.client.presenter.GlobalDialogPresenterWidget.MyView;
 ...
 * {@link com.fountainhead.client.presenter.GlobalDialogPresenterWidget}.
 * 
...
public class GlobalDialogView extends PopupViewImpl implements MyView {
	...
	public void setNavigationPlace(String placeName) {
		if (placeName == null) {
			...
			navigationMessage.setText("Looks like you just navigated to '"
					+ placeName + "'.");
		}
	}
}
