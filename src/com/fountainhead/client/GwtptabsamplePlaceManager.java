...
import com.fountainhead.client.gin.DefaultPlace;
...
public class GwtptabsamplePlaceManager extends PlaceManagerImpl {
	...
	// @Inject
	// public GwtptabsamplePlaceManager(EventBus eventBus,
	...
	public void revealDefaultPlace() {
		...
		// the URL browser, so as not to introduce an // extra history token,
